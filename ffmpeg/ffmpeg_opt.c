...
int ffmpeg_parse_options(int argc, char **argv)
{
    ...
    loge("ffmpeg_parse_options 2.1");
    /* configure terminal and setup signal handlers */
    term_init();
    loge("ffmpeg_parse_options 3");
    /* open input files */
